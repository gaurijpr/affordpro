...
export const RefundPolicy: React.FC = () => {
  const [page, setPage] = useState<PageContent>(() => pageService.getPageContent('refund-policy'));

  useEffect(() => {
    setPage(pageService.getPageContent('refund-policy'));
  }, []);

  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      <Breadcrumb items={[{ label: page.title || 'Refund & Cancellation Policy' }]} />
